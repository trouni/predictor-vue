<template>
  <div class="flex items-stretch fixed w-80 top-1/2 -translate-y-1/2 opacity-90 w-full left-1/2 -translate-x-1/2 rounded-lg overflow-hidden drop-shadow-2xl bg-white">
    ...
    <div class="p-3">
      ...
      <ul>
        ...
        <li v-if='roundNumber === 1' class="flex items-center gap-1"><BaseIcon name="fa-arrow-up"></BaseIcon><BaseIcon name="fa-arrow-down"></BaseIcon><p class="ml-1">for a draw</p></li>
      </ul>
    </div>
  </div>
</template>
